...
class Button extends React.Component {
  render() {
    return (
      <div className="retry-button square-extra-width" onClick={this.props.onClick}>
  ...
  render()
  {
    ...
    switch (this.props.status) {
      ...
      case 3:
        ...
        break;
      default:
        alert("If you're seeing this message, something is very wrong")
    }
    return (
    ...
    if (this.props.width===2) {
      ...
      switch (this.props.status) {
        ...
        case 3:
          ...
          break;
        default:
          alert("Uh oh. you broke the app. Good job")
      }
    }
    return (
      ...
      <React.Fragment>
        <div className="board">
          ...
          <div className="board-row">
            ...
            {this.renderNextRowButton(4)}
          </div>
          <div className="board-row">
            {this.renderSquare(25,this.state.status[25])}
            {this.renderSquare(26,this.state.status[26])}
            {this.renderSquare(27,this.state.status[27])}
            {this.renderSquare(28,this.state.status[28])}
            {this.renderSquare(29,this.state.status[29])}
            {this.renderNextRowButton(5)}
          </div>
        </div>
        <div className="keyboard">
          ...
          <div className="keyboard-row">
          {this.renderButton("Retry", () => {this.retryButtonClick()})}
          {this.renderButton("New Word", () => {this.newWordButtonClick()})}
          </div>
        </div>
      </React.Fragment>
    )
